...
module Input
  def self.update
    ...
    if $CanToggle && trigger?(Input::AUX1)
      ...
      @fasticon.setBitmap(_INTL("Graphics/Icons/SpeedUp/{1}", $GameSpeed))
	  @fasticon.z = 251
    $battleFastIcon.setBitmap(_INTL("Graphics/Icons/SpeedUp/{1}", $GameSpeed)) unless $battleFastIcon.nil?
    end
  end
end
#===============================================================================#
